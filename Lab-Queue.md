...
3. ตัวอย่างการประยุกต์ใช้คิวในการจำลองการรอคิวร้านอาหาร จะเกิดความผิดพลาดในการทำงานกรณีใด จงอธิบาย และจะแก้ไข Code อย่างไรเพื่อแก้ไขปัญหาดังกล่าว (สร้างไฟล์ใหม่ ตั้งขื่อ UpdateQueueRestaurant.py)    -ตอบ จากโค้ดเดิมในกรณีที่คิวว่างจะแสดง "คิวปัจจุบัน: []" ซึ่งอาจเกิดความไม่เข้าใจในการใช้งาน จึงเพิ่มเงื่อนไขในการเช็คว่าคิวว่างหรือไม่ ก่อนทำการโชว์คิวปัจจุบันมีอะไรบ้าง 
...
1. Queue ต่างจาก Stack อย่างไร?
    - Queue จะเป็นการเข้าก่อนออกก่อน มีทางเข้าและทางออกคนละทาง แต่ Stack จะเป็นเข้าก่อนออกทีหลัง ใช้ทางเข้าออกทางเดียวกัน
2. เพราะเหตุใดการ dequeue จึงใช้ pop(0) แทนที่จะเป็น pop()?
    - หากเป็น pop() จะนำข้อมูลตัวสุดท้ายของ list หรือในทีนี้ก็ Queue ออก แต่ dequeue ต้องการนำข้อมูลตัวแรกออกจึงใช้ pop(0) โดยที่เลข 0  คือ index แรกของ list 
3. ยกตัวอย่างการประยุกต์ใช้ Queue ในชีวิตประจำวันมา 3 ตัวอย่าง
    - ต่อคิวรับยา, ต่อคิวร้านกาแฟ, ต่อคิวชำระสินค้า
4. หากต้องการทำ Priority Queue จะต้องปรับปรุงโค้ดอย่างไร?
    - การดำเนินการที่สำคัญใน Priority Queue:
                Enqueue (Insert): เพิ่มข้อมูลใหม่เข้าคิวพร้อมกับระบุลำดับความสำคัญ
                Dequeue (Remove): นำข้อมูลที่มีลำดับความสำคัญสูงสุดออกจากคิว
                Peek: ดูข้อมูลที่มีลำดับความสำคัญสูงสุดโดยไม่ลบออกจากคิว
